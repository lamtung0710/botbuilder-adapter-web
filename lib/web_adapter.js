                            ...
                            if (userWs && userWs.readyState === 1) {
                                try {
                                    ...
                                    if (((_c = message === null || message === void 0 ? void 0 : message.data) === null || _c === void 0 ? void 0 : _c.type) === botbuilder_1.ActivityTypes.Message) {
                                        yield this.storageMessage(message.data.messageType || 'normal_text', (_d = message.data) === null || _d === void 0 ? void 0 : _d.text, true, (_e = message.data) === null || _e === void 0 ? void 0 : _e.user, (_f = message.data) === null || _f === void 0 ? void 0 : _f.from);
                                    }
                                }
                                catch (err) {
                                    console.error(err);
