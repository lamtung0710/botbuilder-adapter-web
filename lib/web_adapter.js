...
const handle_flow_1 = require("./handle_flow");
const redis_service_1 = require("../../../service/cache/redis.service");
...
class WebAdapter extends botbuilder_1.BotAdapter {
    ...
    constructor(socketServerOptions) {
        ...
        this.getHistory = (ChannelId, skip, limit) => {
            return message_web_model_1.default.find({ ChannelId }).sort({ 'CreatedUTCDate': -1 }).skip(skip).limit(limit);
        };
            ...
            ws.on('message', (payload) => __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    ...
                    if (_.get(message, 'type') == 'request') {
                                ...
                                try {
                                    ...
                                    if ((_c = message.data) === null || _c === void 0 ? void 0 : _c.text) {
                                        ...
                                        if (((_d = message === null || message === void 0 ? void 0 : message.data) === null || _d === void 0 ? void 0 : _d.type) === botbuilder_1.ActivityTypes.Message) {
                                            yield this.storageMessage(message.data.Type || 'text', messageData, (_e = message.data) === null || _e === void 0 ? void 0 : _e.user, (_f = message.data) === null || _f === void 0 ? void 0 : _f.from);
                                        }
                                    }
                                    if ((_g = message.data) === null || _g === void 0 ? void 0 : _g.image) {
                                        delete messageData.data.Text;
                                        messageData.data.Type = 'image';
                                        messageData.data['Url'] = (_h = message.data) === null || _h === void 0 ? void 0 : _h.image;
                                        userWs.send(JSON.stringify(messageData));
                                        ws.send(JSON.stringify(messageData));
                                        if (((_j = message === null || message === void 0 ? void 0 : message.data) === null || _j === void 0 ? void 0 : _j.type) === botbuilder_1.ActivityTypes.Message) {
                                            yield this.storageMessage(message.data.Type || 'text', messageData, (_k = message.data) === null || _k === void 0 ? void 0 : _k.user, (_l = message.data) === null || _l === void 0 ? void 0 : _l.from);
                                        }
                                    }
                                    if ((_m = message.data) === null || _m === void 0 ? void 0 : _m.file) {
                                        delete messageData.data.Text;
                                        messageData.data.Type = 'file';
                                        messageData.data['FileName'] = ((_o = message.data) === null || _o === void 0 ? void 0 : _o.fileName) || ((_p = message.data) === null || _p === void 0 ? void 0 : _p.file.substring(((_q = message.data) === null || _q === void 0 ? void 0 : _q.file.lastIndexOf('/')) + 1));
                                        messageData.data['Url'] = (_r = message.data) === null || _r === void 0 ? void 0 : _r.file;
                                        userWs.send(JSON.stringify(messageData));
                                        ws.send(JSON.stringify(messageData));
                                        if (((_s = message === null || message === void 0 ? void 0 : message.data) === null || _s === void 0 ? void 0 : _s.type) === botbuilder_1.ActivityTypes.Message) {
                                            yield this.storageMessage(message.data.Type || 'text', messageData, (_t = message.data) === null || _t === void 0 ? void 0 : _t.user, (_u = message.data) === null || _u === void 0 ? void 0 : _u.from);
                                        }
                                    }
                                }
                                catch (err) {
                        ...
                        if (_.get(message, 'value') == 'choose-flow') {
                            console.log('hihi');
                            const userWs = clients[message.user];
                            const { flowId, nextStepId, isButton, botId, audienceId } = message;
                            if (userWs && userWs.readyState === 1) {
                                try {
                                    const flow = yield redis_service_1.RedisService.getKey(`BOT_FLOW:${botId}:${flowId}`);
                                    if (flow) {
                                        const blocks = JSON.parse(flow).findBotFlowBlock;
                                        if (isButton) {
                                            yield handle_flow_1.recursive(message.botId, audienceId, blocks, nextStepId, ws, userWs);
                                        }
                                        else {
                                            const blockStartStep = blocks.find(block => {
                                                return !block.IsDelete && block.BlockType.BlockTypeName === "Startstep";
                                            });
                                            yield handle_flow_1.recursive(botId, audienceId, blocks, blockStartStep.NextStepId, ws, userWs);
                                        }
                                    }
                                }
                                catch (error) {
                        ...
                        if ((_v = message.data) === null || _v === void 0 ? void 0 : _v.image) {
                            delete messageData.data.Text;
                            messageData.data.Type = 'image';
                            messageData.data['Url'] = message === null || message === void 0 ? void 0 : message.image;
                        }
                        if ((_w = message.data) === null || _w === void 0 ? void 0 : _w.file) {
                            delete messageData.data.Text;
                            messageData.data.Type = 'file';
                            messageData.data['FileName'] = (message === null || message === void 0 ? void 0 : message.fileName) || ((_x = message.data) === null || _x === void 0 ? void 0 : _x.file.substring((message === null || message === void 0 ? void 0 : message.file.lastIndexOf('/')) + 1));
                            messageData.data['Url'] = message === null || message === void 0 ? void 0 : message.file;
                        }
                        messageData['user'] = message.user;
                        this.sendMessage(messageData);
                        if ((message === null || message === void 0 ? void 0 : message.type) === botbuilder_1.ActivityTypes.Message) {
                            yield this.storageMessage(messageData.data.Type || 'text', messageData, message === null || message === void 0 ? void 0 : message.user, message === null || message === void 0 ? void 0 : message.from);
                        }
                    }
                }
                catch (e) {
