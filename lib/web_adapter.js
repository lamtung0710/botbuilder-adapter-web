...
class WebAdapter extends botbuilder_1.BotAdapter {
    ...
    constructor(socketServerOptions) {
        ...
        this.getHistory = (ChannelId, skip, limit) => __awaiter(this, void 0, void 0, function* () {
            return yield message_web_model_1.default.find({ ChannelId }).sort({ 'CreatedUTCDate': -1 }).skip(skip).limit(limit).reserved();
        });
