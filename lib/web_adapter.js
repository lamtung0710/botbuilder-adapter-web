                ...
                try {
                    ...
                    if (_.get(message, 'type') == 'request') {
                        ...
                        if (_.get(message, 'value') == 'message' && (message === null || message === void 0 ? void 0 : message.data)) {
                            ...
                            if (userWs && userWs.readyState === 1) {
                                try {
                                    ...
                                    if (((_b = message === null || message === void 0 ? void 0 : message.data) === null || _b === void 0 ? void 0 : _b.type) === botbuilder_1.ActivityTypes.Message) {
                                        yield this.storageMessage(message.data.messageType || 'normal_text', (_c = message.data) === null || _c === void 0 ? void 0 : _c.text, true, (_d = message.data) === null || _d === void 0 ? void 0 : _d.user, (_e = message.data) === null || _e === void 0 ? void 0 : _e.from);
                                    }
                                }
                                catch (err) {
                                    console.error(err);
                        ...
                        if (message.type === botbuilder_1.ActivityTypes.Message) {
                            yield this.storageMessage(message.messageType || 'normal_text', message.text, false, message.user, message.from);
                        }
                    }
                }
                catch (e) {
                    ...
                    if (ws && ws.readyState === 1) {
                        try {
                            ...
                            if ((message === null || message === void 0 ? void 0 : message.type) === botbuilder_1.ActivityTypes.Message && message.text) {
                                yield this.storageMessage(message.messageType || 'normal_text', message.text, true, message.user, message.from);
                            }
                        }
                        catch (err) {
                            console.error(err);
