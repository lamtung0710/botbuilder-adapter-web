                ...
                try {
                    ...
                    if (_.get(message, 'type') == 'request') {
                                ...
                                try {
                                    ...
                                    if ((_m = message.data) === null || _m === void 0 ? void 0 : _m.file) {
                                        ...
                                        if (((_s = message === null || message === void 0 ? void 0 : message.data) === null || _s === void 0 ? void 0 : _s.type) === botbuilder_1.ActivityTypes.Message) {
                                            yield this.storageMessage(message.data.messageType || 'text', messageData, (_t = message.data) === null || _t === void 0 ? void 0 : _t.user, (_u = message.data) === null || _u === void 0 ? void 0 : _u.from);
                                        }
                                    }
                                }
                                catch (err) {
                        ...
                        if ((message === null || message === void 0 ? void 0 : message.type) === botbuilder_1.ActivityTypes.Message && (message === null || message === void 0 ? void 0 : message.data.Type)) {
                            yield this.storageMessage(message.data.messageType || 'text', messageData, (_3 = message.data) === null || _3 === void 0 ? void 0 : _3.user, (_4 = message.data) === null || _4 === void 0 ? void 0 : _4.from);
                        }
                    }
                }
                catch (e) {
