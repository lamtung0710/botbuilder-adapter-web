                            ...
                            try {
                                ...
                                if ((message === null || message === void 0 ? void 0 : message.type) === botbuilder_1.ActivityTypes.Message && message.text) {
                                    const messageData = {
                                        ...
                                        "bot": true,
                                        "data": {
                                            "Type": ((_a = message.data) === null || _a === void 0 ? void 0 : _a.messageType) || 'text',
                                            "Text": (_b = message.data) === null || _b === void 0 ? void 0 : _b.text,
                                            "Buttons": []
                                        },
                                        "eventEmit": "received_message"
                                    };
                                    if ((_c = message.data) === null || _c === void 0 ? void 0 : _c.image) {
                                        delete messageData.data.Text;
                                        messageData.data.Type = 'image';
                                        messageData.data['Url'] = (_d = message.data) === null || _d === void 0 ? void 0 : _d.image;
                                    }
                                    if ((_e = message.data) === null || _e === void 0 ? void 0 : _e.file) {
                                        delete messageData.data.Text;
                                        messageData.data.Type = 'file';
                                        messageData.data['FileName'] = ((_f = message.data) === null || _f === void 0 ? void 0 : _f.fileName) || ((_g = message.data) === null || _g === void 0 ? void 0 : _g.file.substring(((_h = message.data) === null || _h === void 0 ? void 0 : _h.file.lastIndexOf('/')) + 1));
                                        messageData.data['Url'] = (_j = message.data) === null || _j === void 0 ? void 0 : _j.file;
                                    }
                                    yield this.storageMessage(messageData.data.Type || 'text', messageData.data, message.user, message.from);
                                }
                            }
                            catch (err) {
                                console.error(err);
