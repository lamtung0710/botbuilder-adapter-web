                ...
                try {
                    ...
                    if (_.get(message, 'type') == 'request') {
                        ...
                        const messageData = {
                            ...
                            "bot": true,
                            "data": {
                                "Type": (message === null || message === void 0 ? void 0 : message.data.messageType) || 'text',
                                "Text": ((_v = message === null || message === void 0 ? void 0 : message.data) === null || _v === void 0 ? void 0 : _v.text) || message.text,
                                "Buttons": []
                            },
                            "eventEmit": "received_message"
                        };
                        ...
                        if ((_x = message.data) === null || _x === void 0 ? void 0 : _x.file) {
                            delete messageData.data.Text;
                            messageData.data.Type = 'file';
                            messageData.data['FileName'] = (message === null || message === void 0 ? void 0 : message.fileName) || ((_y = message.data) === null || _y === void 0 ? void 0 : _y.file.substring((message === null || message === void 0 ? void 0 : message.file.lastIndexOf('/')) + 1));
                        ...
                        if ((message === null || message === void 0 ? void 0 : message.type) === botbuilder_1.ActivityTypes.Message && (message === null || message === void 0 ? void 0 : message.data.Type)) {
                            yield this.storageMessage(message.type || 'text', messageData, message === null || message === void 0 ? void 0 : message.user, message === null || message === void 0 ? void 0 : message.from);
                        }
                    }
                }
                catch (e) {
