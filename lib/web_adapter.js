                            ...
                            try {
                                ...
                                if ((message === null || message === void 0 ? void 0 : message.type) === botbuilder_1.ActivityTypes.Message && message.text) {
                                    const messageData = {
                                        ...
                                        "data": {
                                            "Type": message.data.messageType || 'text',
                                            "Text": (_a = message.data) === null || _a === void 0 ? void 0 : _a.text,
                                            "Buttons": []
                                        },
                                        "eventEmit": "received_message"
                                    };
                                    if ((_b = message.data) === null || _b === void 0 ? void 0 : _b.image) {
                                        delete messageData.data.Text;
                                        messageData.data.Type = 'image';
                                        messageData.data['Url'] = (_c = message.data) === null || _c === void 0 ? void 0 : _c.image;
                                    }
                                    if ((_d = message.data) === null || _d === void 0 ? void 0 : _d.file) {
                                        delete messageData.data.Text;
                                        messageData.data.Type = 'file';
                                        messageData.data['FileName'] = ((_e = message.data) === null || _e === void 0 ? void 0 : _e.fileName) || ((_f = message.data) === null || _f === void 0 ? void 0 : _f.file.substring(((_g = message.data) === null || _g === void 0 ? void 0 : _g.file.lastIndexOf('/')) + 1));
                                        messageData.data['Url'] = (_h = message.data) === null || _h === void 0 ? void 0 : _h.file;
                                    }
