                ...
                try {
                    ...
                    if (_.get(message, 'type') == 'request') {
                            ...
                            if (userWs && userWs.readyState === 1) {
                                try {
                                    ...
                                    if ((_c = message.data) === null || _c === void 0 ? void 0 : _c.image) {
                                        ...
                                        messageData.data['image'] = (_d = message.data) === null || _d === void 0 ? void 0 : _d.image;
                                    }
                                    if ((_e = message.data) === null || _e === void 0 ? void 0 : _e.file) {
                                        delete messageData.data.Text;
                                        messageData.data['file'] = (_f = message.data) === null || _f === void 0 ? void 0 : _f.file;
                                    }
                                    userWs.send(JSON.stringify(messageData));
                                    ws.send(JSON.stringify(messageData));
                                    if (((_g = message === null || message === void 0 ? void 0 : message.data) === null || _g === void 0 ? void 0 : _g.type) === botbuilder_1.ActivityTypes.Message) {
                                        yield this.storageMessage(message.data.messageType || 'text', messageData, (_h = message.data) === null || _h === void 0 ? void 0 : _h.user, (_j = message.data) === null || _j === void 0 ? void 0 : _j.from);
                                    }
                                }
                                catch (err) {
                                    console.error(err);
                        ...
                        if (message.type === botbuilder_1.ActivityTypes.Message) {
                            yield this.storageMessage(message.messageType || 'text', message.text, message.user, message.from);
                        }
                    }
                }
                catch (e) {
