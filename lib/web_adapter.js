                ...
                try {
                    ...
                    if (_.get(message, 'type') == 'request') {
                        ...
                        if ((message === null || message === void 0 ? void 0 : message.type) === botbuilder_1.ActivityTypes.Message && (message === null || message === void 0 ? void 0 : message.data.type)) {
                            yield this.storageMessage(message.messageType || 'text', message.data, message.user, message.from);
                        }
                    }
                }
                catch (e) {
                    ...
                    if (ws && ws['room']['audienceId'] && ws['room']['botId']) {
                        ...
                        if (ws && ws.readyState === 1) {
                            try {
                                ...
                                this.sendMessage(message);
                                if ((message === null || message === void 0 ? void 0 : message.type) === botbuilder_1.ActivityTypes.Message && (message === null || message === void 0 ? void 0 : message.data.type)) {
                                    yield this.storageMessage(message.data.Type || 'text', message.data, message.user, message.from);
                                }
                            }
                            catch (err) {
                                console.error(err);
