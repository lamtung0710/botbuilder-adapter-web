                ...
                try {
                    ...
                    if (_.get(message, 'type') == 'request') {
                        ...
                        const messageData = {
                            ...
                            "data": {
                                "Type": message.data.messageType || 'text',
                                "Text": (_v = message.data) === null || _v === void 0 ? void 0 : _v.text,
                                "Buttons": []
                            },
                            "eventEmit": "received_message"
                        };
                        if ((_w = message.data) === null || _w === void 0 ? void 0 : _w.image) {
                            delete messageData.data.Text;
                            messageData.data.Type = 'image';
                            messageData.data['Url'] = (_x = message.data) === null || _x === void 0 ? void 0 : _x.image;
                        }
                        if ((_y = message.data) === null || _y === void 0 ? void 0 : _y.file) {
                            delete messageData.data.Text;
                            messageData.data.Type = 'file';
                            messageData.data['FileName'] = ((_z = message.data) === null || _z === void 0 ? void 0 : _z.fileName) || ((_0 = message.data) === null || _0 === void 0 ? void 0 : _0.file.substring(((_1 = message.data) === null || _1 === void 0 ? void 0 : _1.file.lastIndexOf('/')) + 1));
                            messageData.data['Url'] = (_2 = message.data) === null || _2 === void 0 ? void 0 : _2.file;
                        }
                        if ((message === null || message === void 0 ? void 0 : message.type) === botbuilder_1.ActivityTypes.Message && (message === null || message === void 0 ? void 0 : message.data.Type)) {
                            yield this.storageMessage(message.data.type || 'text', messageData, (_3 = message.data) === null || _3 === void 0 ? void 0 : _3.user, (_4 = message.data) === null || _4 === void 0 ? void 0 : _4.from);
                        }
                    }
                }
                catch (e) {
