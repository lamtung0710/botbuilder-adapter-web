                            ...
                            if (userWs && userWs.readyState === 1) {
                                try {
                                    ...
                                    if (((_g = message === null || message === void 0 ? void 0 : message.data) === null || _g === void 0 ? void 0 : _g.type) === botbuilder_1.ActivityTypes.Message) {
                                        yield this.storageMessage(message.data.messageType || 'text', (_h = message.data) === null || _h === void 0 ? void 0 : _h.text, true, (_j = message.data) === null || _j === void 0 ? void 0 : _j.user, (_k = message.data) === null || _k === void 0 ? void 0 : _k.from);
                                    }
                                }
                                catch (err) {
                                    console.error(err);
